...
if (!$data) {
   echo "<tr class='row1'><td colspan=12 align=center>Empty</td></tr>";
}
...
echo "</td>";
echo "</table>";
echo "<br><br><center class='smalltext'>Page created in ".$restime=round(microtime(true)-$execstart,3)." secs.<br><a href='http://rtgui.googlecode.com'>rtGui v.1</a> - &copy; Copyright Simon Hall 2007</center>";
